...
const ClientInfo = () => {
  ...
  const selectedService = services.find(
    (service) => service.id == splitedId[0]
  );
  ...
  return (
    <>
      <PageTitle title={"Client Info"} />
      <section className="client-info">
        <div className="client-info-form">
          <p>
            Leave your contact here and I will get back to you asap. <br /> I'm
            here to help you.
          </p>
        ...
        <div className="selected-event">
          ...
          <div className="selected-service-card">
            ...
            <div className="selected-service-card-content">
              ...
              <p>
                Package: <strong>{splitedId[1]}</strong>
              </p>
              <p>
          ...
          <div className="selected-package-card"></div>
        </div>
      </section>
    </>
  );
